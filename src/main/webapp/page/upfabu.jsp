...
name=floorage></TD></TR>
  ...
  <TR>
    ...
    <TD><INPUT class=text
               value="<c:formatDate value="${house.pubdate}" pattern="yyyy-MM-dd"></c:formatDate>"
               type=date name=houseDate></TD></TR>
  <TR>
    <TD class=field>位　　置：</TD>
    <TD>区：<SELECT class=text id="district_id" name=districtId ><OPTION selected>请选择</OPTION></SELECT>
        街：<SELECT class=text id="street_id" name=streetId><OPTION selected >请选择</OPTION></SELECT> </TD></TR><!--
						<tr>
  ...
  <tr>
    ...
    <td>
      <img src="http://localhost:80/${house.path}" height="100" width="80">
